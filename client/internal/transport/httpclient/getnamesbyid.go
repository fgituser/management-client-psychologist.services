...
//GetNamesByID getting names by identifiers
func (h *HTTPClient) GetNamesByID(psychologistID, clientID, userRole string) ([]*model.Client, error) {
	...
	res, err := h.Do(nil,
		fmt.Sprintf("/employees/%v/clients/%v/lessons", psychologistID, clientID),
		userRole)
	if err != nil {
	...
	return convertresponseGetNamesByIDToModelClient(dd, nil), nil
}
