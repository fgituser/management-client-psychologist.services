...
func TestHTTPClient_ClientLessonSet(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			name:    "valid",
			h:       New(),
			args:    args{clientID: "75d2cdd6-cf69-44e7-9b28-c47792505d81", psychologistID: "80d2cdd6-cf69-44e7-9b28-c47792505d81", userRole: "client", dateTime: time.Date(2020, 3, 31, 0, 0, 0, 0, time.UTC)},
			wantErr: false,
		},
		{
			name:    "not valid clientDI",
			h:       New(),
			args:    args{clientID: " ", psychologistID: "80d2cdd6-cf69-44e7-9b28-c47792505d81", userRole: "client", dateTime: time.Date(2020, 3, 31, 0, 0, 0, 0, time.UTC)},
			wantErr: true,
		},
		{
